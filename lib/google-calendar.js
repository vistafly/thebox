...
/**
 * Generate time slots for bookable hours
 * BOOKING HOURS: 7:00 AM - 12:00 AM (midnight)
 */
function generateTimeSlots() {
  const slots = [];

  // Generate hourly slots from 7 AM to 11 PM (last slot starts at 11 PM, ends at midnight)
